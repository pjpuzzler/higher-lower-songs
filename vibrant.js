        ...
        /******/ [
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Vibrant = /** @class */ (function () {
                    ...
                    Vibrant.prototype._process = function (image, opts) {
                        ...
                        var processOpts = options_1.buildProcessOptions(
                            this.opts,
                            opts
                        );
                        return Vibrant._pipeline.process(
                            image.getImageData(),
                            processOpts
                        );
                    };
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function rgbToXyz(r, g, b) {
                    ...
                    r =
                        r > 0.04045
                            ? Math.pow((r + 0.005) / 1.055, 2.4)
                            : r / 12.92;
                    g =
                        g > 0.04045
                            ? Math.pow((g + 0.005) / 1.055, 2.4)
                            : g / 12.92;
                    b =
                        b > 0.04045
                            ? Math.pow((b + 0.005) / 1.055, 2.4)
                            : b / 12.92;
                    r *= 100;
                    g *= 100;
                    b *= 100;
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                config_1.default.DefaultOpts.ImageClass =
                    image_browser_1.default;
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Builder = /** @class */ (function () {
                    function Builder(src, opts) {
                        ...
                        this._src = src;
                        this._opts = utils_1.assignDeep(
                            {},
                            _1.default.DefaultOpts,
                            opts
                        );
                    }
                    ...
                    Builder.prototype.useGenerator = function (
                        generator,
                        options
                    ) {
                        ...
                        this._opts.generators.push(
                            options
                                ? { name: generator, options: options }
                                : generator
                        );
                        return this;
                    };
                    Builder.prototype.useQuantizer = function (
                        quantizer,
                        options
                    ) {
                        this._opts.quantizer = options
                            ? { name: quantizer, options: options }
                            : quantizer;
                        return this;
                    };
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var BrowserImage = /** @class */ (function (_super) {
                    ...
                    BrowserImage.prototype.resize = function (
                        targetWidth,
                        targetHeight,
                        ratio
                    ) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var generator_default_1 = __importDefault(
                    __webpack_require__(16)
                );
                var pipeline_1 = __webpack_require__(17);
                var pipeline = new pipeline_1.BasicPipeline().filter
                    .register("default", function (r, g, b, a) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function _findColorVariation(
                    ...
                    swatches.forEach(function (swatch) {
                        ...
                        if (
                            ...
                            var value = _createComparisonValue(
                                s,
                                targetSaturation,
                                l,
                                targetLuma,
                ...
                function _generateEmptySwatches(palette, maxPopulation, opts) {
                    ...
                    if (!palette.LightVibrant && palette.Vibrant) {
                        ...
                        palette.LightVibrant = new color_1.Swatch(
                            converter_1.hslToRgb(h, s, l),
                            0
                        );
                    }
                    if (!palette.Muted && palette.Vibrant) {
                        ...
                        palette.Muted = new color_1.Swatch(
                            converter_1.hslToRgb(h, s, l),
                            0
                        );
                    }
                    if (!palette.DarkMuted && palette.DarkVibrant) {
                        var _h = palette.DarkVibrant.hsl,
                            ...
                            l = _h[2];
                        l = opts.targetMutesSaturation;
                        palette.DarkMuted = new color_1.Swatch(
                            converter_1.hslToRgb(h, s, l),
                            0
                        );
                    }
                    if (!palette.LightMuted && palette.LightVibrant) {
                        var _j = palette.LightVibrant.hsl,
                            ...
                            l = _j[2];
                        l = opts.targetMutesSaturation;
                        palette.LightMuted = new color_1.Swatch(
                            converter_1.hslToRgb(h, s, l),
                            0
                        );
                    }
                ...
                var DefaultGenerator = function (swatches, opts) {
                    ...
                    var palette = _generateVariationColors(
                        swatches,
                        maxPopulation,
                        opts
                    );
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var BasicPipeline = /** @class */ (function () {
                    ...
                    BasicPipeline.prototype.process = function (
                        imageData,
                        opts
                    ) {
                        return __awaiter(this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        (_a = this._buildProcessTasks(opts)),
                                            (filters = _a.filters),
                                            (quantizer = _a.quantizer),
                                            (generators = _a.generators);
                                        return [
                    ...
                    BasicPipeline.prototype._filterColors = function (
                        filters,
                        imageData
                    ) {
                        return Promise.resolve(
                            image_1.applyFilters(
                                imageData,
                    ...
                    BasicPipeline.prototype._generateColors = function (
                        quantizer,
                        imageData
                    ) {
                        return Promise.resolve(
                            quantizer.fn(imageData.data, quantizer.options)
                        );
                    };
                    BasicPipeline.prototype._generatePalettes = function (
                        generators,
                        colors
                    ) {
                        return __awaiter(this, void 0, void 0, function () {
